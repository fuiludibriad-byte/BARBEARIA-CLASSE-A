...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      <img
        src="https://i.imgur.com/kyF5Er7.jpeg"
      ...
      >
        ...
        <h1 className="text-4xl md:text-7xl font-bold mb-6">
          Atendimento{' '}
          <span className="text-primary">Classe A!</span>
        </h1>
        <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
          Corte de cabelo, barba alinhada e o cuidado exclusivo que você merece. Agende sua experiência na BARBEARIA CLASSE A.
        </p>
